...
public class TicTacToeGUI extends JFrame {
    ...
    JFrame frame = new JFrame("Arin's Tic Tac Toe");
        ...
        public void actionPerformed(ActionEvent action) {
            ...
            if (action.getSource() == resetButton) {
                for (int i = 0; i < 9; i++) {
                    ...
                    frame.setTitle("Arin's Tic Tac Toe");
                }
                board.reset();
            }
        }
    ...
    public void gameOver() {
        ...
        if (board.isWinner(board.getPlayer())) {
            ...
            frame.setTitle("Arin's Tic Tac Toe: ***** PLAYER WINS *****");
        } else if (board.isWinner(board.getComputer())) {
            frame.setTitle("Arin's Tic Tac Toe: ***** COMPUTER WINS *****");
            JOptionPane.showMessageDialog(frame, "Bad luck. You Lose. Better Luck Next Time!");

        } else {
            JOptionPane.showMessageDialog(frame, "Draw.");
            frame.setTitle("Arin's Tic Tac Toe: ***** IT'S A DRAW *****");
        }
    }
